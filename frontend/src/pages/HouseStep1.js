...
const inputBoxStyle = css`align-self: stretch; border-radius: 6px; background-color: #f6f7f9; border: 1px solid #eaecf0; display: flex; flex-direction: row; align-items: center; justify-content: space-between; padding: 15px 16px; gap: 0px; font-size: 16px;&::placeholder {
    color: #bdc5d0;
...
const inputHalfBoxStyle = css`width: 359.5px; border-radius: 6px; background-color: #f6f7f9; border: 1px solid #eaecf0; box-sizing: border-box; display: flex; flex-direction: row; align-items: center; justify-content: flex-start; padding: 15px 16px; font-size: 16px; &::placeholder {
    color: #bdc5d0;
    text-transform: capitalize;
  }`;

const inputHalfBoxRightStyle = css`height: 51px; width: 360px; border-radius: 6px; background-color: #f6f7f9; border: 1px solid #eaecf0; box-sizing: border-box; display: flex; flex-direction: row; align-items: center; justify-content: space-between; padding: 15px 16px; gap: 0px; font-size: 16px; 
    &::placeholder {
    color: #bdc5d0;
    text-transform: capitalize;
  }`;
              ...
              {[
                ...
                <div key={num} className={stepItemStyle}>
                  <div className={stepTextContainerStyle}>
                    ...
                    <div className={stepTitleStyle}>{title}</div>
                  </div>
      ...
      <div className={mainPanelStyle}>
            ...
            <div className={inputGroupStyle}>
              ...
              <div className={css`display: flex; gap: 20px; width: 100%;`}>
                ...
                <div className={inputHalfStyle}>
                  ...
                  <select
                    className={dropdownBoxStyle(houseType !== "")}
                    value={houseType}
                    onChange={(e) => setHouseType(e.target.value)}
                  >
                    <option value="" disabled hidden>집 형태를 선택해주세요</option>
        ...
        <div className={bottomNavStyle}>
          ...
          <div
            ...
            onClick={isNextEnabled ? HouseStep2 : undefined}
          >
