    ...
    <div className={styles.container}>
      ...
      <div className={styles.buttonWrapper}>
        ...
        <div className={styles.buttonOrange} onClick={handleReadyClick}>
          <div className={styles.stepText}>열려있어 →</div>
        </div>
      </div>
      ...
      <div className={styles.checkText}>방문이 열려있는지 닫혀있는지 지금 확인해볼까?</div>
      <img className={styles.doorIcon} src="/images/시나리오/객체/플러스.png" alt="" />
    </div>
  );
};
